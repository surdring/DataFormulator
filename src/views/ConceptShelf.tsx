...
export const ConceptGroup: FC<{groupName: string, fields: FieldItem[]}> = function ConceptGroup({groupName, fields}) {
    ...
    return <Box>
            ...
            <Divider orientation="horizontal" textAlign="left">
                <Box sx={{ 
                    ...
                    <Typography component="h2" sx={{fontSize: "10px", display: 'flex', alignItems: 'center',
                        ...
                        {groupName === "new fields" ? t('concept.group.newFields') : groupName}
        ...
        {hasMoreFields && !expanded && (
            ...
            >
                {`${t('concept.showAll.prefix')}${fields.length} ${groupName === "new fields" ? t('concept.group.newFields') : groupName}${t('concept.showAll.suffix')}`}
            </Button>
        )}
    </Box>;
}
