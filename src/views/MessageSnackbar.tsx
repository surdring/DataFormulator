                ...
                <Paper elevation={3} sx={{
                    ...
                    <Box sx={{display: 'flex', alignItems: 'center', px: 1.5}}>
                        <Typography variant="subtitle1" sx={{fontSize: 12, flexGrow: 1, color: 'text.secondary'}}>
                            {t('messages.panel.header').replace('{count}', String(messages.length))}
                        </Typography>
                    ...
                    >
                        {messages.length == 0 && 
                        <Typography fontSize={12} component="span" sx={{margin: "auto", m: 1, opacity: 0.7, fontStyle: 'italic'}}>{t('messages.panel.empty')}</Typography>}
            ...
            >
                <Alert onClose={handleClose} severity={latestMessage?.type} sx={{ maxWidth: '400px', maxHeight: '600px', overflow: 'auto' }}>
                    ...
                    {latestMessage?.detail ? 
                        <Divider textAlign="left" sx={{my: 1, fontSize: 12, opacity: 0.7}} > {t('messages.last.detail.section')} </Divider>
                    : ""}
                    {latestMessage?.detail ? 
                        <Box sx={{ borderRadius: 1, position: 'relative' }} >
                    ...
                    : ""}
                    {latestMessage?.code ? 
                        <Divider textAlign="left" sx={{my: 1, fontSize: 12, opacity: 0.7}} > {t('messages.last.code.section')} </Divider>
                    : ""}
                    {latestMessage?.code ? 
