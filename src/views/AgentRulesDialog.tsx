...
export const AgentRulesDialog: React.FC = () => {
    ...
    // Placeholder content（使用 i18n 中的中文示例）
    const codingPlaceholder = t('agentRules.coding.placeholder');

    const explorationPlaceholder = t('agentRules.exploration.placeholder');
                ...
                <DialogContent>
                    ...
                    <Box>
                        <Typography variant="body2" sx={{ mb: 1, fontWeight: 600, color: 'secondary.main' }}>
                            {t('agentRules.exploration.title')}
                            <Typography variant="body2" component="span" color="text.secondary" sx={{ ml: 1, fontSize: 12 }}>
                                {t('agentRules.exploration.subtitle')}
                            </Typography>
                        </Typography>
                        <Box
                            sx={{
