...
const features: Feature[] = [
    {
        title: t('about.feature.loadAny.title'),
        description: t('about.feature.loadAny.desc'),
        media: "/feature-extract-data.mp4",
        mediaType: "video"
    },
    {
        title: t('about.feature.agentMode.title'),
        description: t('about.feature.agentMode.desc'),
        media: "/feature-agent-mode.mp4",
        mediaType: "video"
    },
    {
        title: t('about.feature.interactive.title'),
        description: t('about.feature.interactive.desc'),
        media: "/feature-interactive-control.mp4",
        mediaType: "video"
    },
    {
        title: t('about.feature.verifyShare.title'),
        description: t('about.feature.verifyShare.desc'),
...
const screenshots: {url: string, description: string}[] = [
    {url: "/data-formulator-screenshot-v0.5.webp", description: t('about.screenshot.prices')},
    {url: "/screenshot-movies-report.webp", description: t('about.screenshot.movies')},
    {url: "/screenshot-renewable-energy.webp", description: t('about.screenshot.renewable')},
    {url: '/screenshot-unemployment.webp', description: t('about.screenshot.unemployment')},
    {url: '/screenshot-claude-performance.webp', description: t('about.screenshot.claude')},
];
            ...
            <Box sx={{margin:'auto', pb: '5%', display: "flex", flexDirection: "column", textAlign: "center", maxWidth: 1200}}>
                ...
                <Box sx={{ mt: 6, mx: 2 }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        >
                            <ul>
                                <li>{t('about.dataHandling.storage')}</li>
                                <li>{t('about.dataHandling.processing')}</li>
                                <li>{t('about.dataHandling.database')}</li>
                                <li>{t('about.dataHandling.llm')}</li>
                            </ul>
                        </Typography>
                        <Typography variant="caption" sx={{ mt: 4,color: 'text.secondary', fontWeight: 300, letterSpacing: '0.02em' }}>
                            {t('about.dataHandling.footer')}
                        </Typography>
                    </Box>
                </Box>
            </Box>
