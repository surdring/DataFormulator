        ...
        return <Box sx={{marginTop: 2}}>
            <Box sx={{width: '100%', display: 'flex', alignItems: 'center'}}>
                <Typography fontSize="small" sx={{color: 'gray'}}>
                    {t('derivedData.source.prefix')}
                    <Typography component="span" fontSize="inherit" sx={{textDecoration: 'underline'}}>
            ...
            <Box sx={{width: '100%', display: 'flex', alignItems: 'center'}}>
                <Box sx={{ display: 'flex', margin: 'auto'}}>
                    <ButtonGroup size="small" sx={{margin: 'auto'}}>
                        {/* <Button sx={{textTransform: 'none'}} onClick={()=>{ handleCloseDialog() }}>{t('common.cancel')}</Button> */}
                        <Button
                        ...
                        >
                            {t('derivedData.button.deleteAll')}
                        </Button>
                        <Button
                            sx={{textTransform: 'none', width: '300px', margin: 'auto',}}
                            variant="text"
                            startIcon={<SaveIcon />}
                            onClick={() => { handleSelection(selectionIdx)} }
                        >
                            {t('derivedData.button.save')
                                .replace('{index}', String(selectionIdx + 1))
                                .replace('{tableId}', candidateTables[selectionIdx].id)}
                        </Button>
                    </ButtonGroup>
                </Box>
            </Box>
